...
public class ComputerNetworksCommonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_networks_common);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Theory").child("Computer Networks S4");
        ...
        String message = intent.getStringExtra("Computer Networks");
