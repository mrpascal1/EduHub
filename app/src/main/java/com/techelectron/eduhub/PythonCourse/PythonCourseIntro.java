...
public class PythonCourseIntro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_course_intro);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Theory").child("Python Course");
        ...
        String message = intent.getStringExtra("Python Course");
