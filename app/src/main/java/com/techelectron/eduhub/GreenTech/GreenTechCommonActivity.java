...
public class GreenTechCommonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_tech_common);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Theory").child("Green Tech").child("Green Tech Common");
        ...
        String message = intent.getStringExtra("Green Tech");
